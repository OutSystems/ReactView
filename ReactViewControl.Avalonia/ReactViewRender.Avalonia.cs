...
namespace ReactViewControl {
    ...
    partial class ReactViewRender : Control {
        ...
        partial void PreloadWebView() {
            ...
            var initialBrowserSizeWidth = (int)window.Screens.All.Max(s => s.WorkingArea.Width * (ExtendedWebView.OsrEnabled ? 1 : s.PixelDensity));
            var initialBrowserSizeHeight = (int)window.Screens.All.Max(s => s.WorkingArea.Height * (ExtendedWebView.OsrEnabled ? 1 : s.PixelDensity));
        ...
        protected override void OnPropertyChanged<T>(AvaloniaPropertyChangedEventArgs<T> change) {
            ...
            if (!ExtendedWebView.OsrEnabled && change.Property == IsEffectivelyEnabledProperty) {
